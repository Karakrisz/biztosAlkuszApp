...
<template>
  <section>
    <div class="aszf-content subpage-two-services-content">
      <h4 class="aszf-content__h4">Adatkezelési Tájékoztató</h4>

      <p class="aszf-content__p">Elfogadás dátuma: 2022.10.13</p>

      <h5 class="aszf-content__h5">1. ADATKEZELŐ</h5>
      <p class="aszf-content__p">finaligaborrabbi@gmail.com</p>

      <h5 class="aszf-content__h5">2. A WEBOLDAL ÜZEMELTETÉSE SORÁN VÉGZETT ADATKEZELÉSEK LEÍRÁSA</h5>

      <h5 class="aszf-content__5">2.1 A COOKIE-K HASZNÁLATÁVAL KAPCSOLATOS TÁJÉKOZTATÁS</h5>
      <p class="aszf-content__p">
      ...
      <h5 class="aszf-content__h5">2.1.1. Google Adwords cookie</h5>
      <p class="aszf-content__p">
      ...
      <h5 class="aszf-content__h5">2.1.2. Facebook pixel (Facebook cookie)</h5>
      <p class="aszf-content__p">
      ...
      <h5 class="aszf-content__h5">2.2. HÍRLEVÉL-CÉLÚ ADATKEZELÉSEK</h5>
      <p class="aszf-content__p">
      ...
      <h5 class="aszf-content__h5">2.3. KAPCSOLATFELVÉTEL SZEMÉLYES ADATOK MEGADÁSA CÉLJÁBÓL</h5>
      <p class="aszf-content__p">
      ...
      <h5 class="aszf-content__h5">2.4. KÖZÖSSÉGI ESEMÉNYEK BEMUTATÁSA</h5>
      <p class="aszf-content__p">
      ...
      <h5 class="aszf-content__h5">2.5. A HOZZÁJÁRULÁS IGAZOLHATÓSÁGÁVAL KAPCSOLATBAN KEZELT ADATOK</h5>
      <p class="aszf-content__p">
      ...
      <h5 class="aszf-content__h5">3. AZ ADATKEZELÉS SORÁN ÖNT MEGILLETŐ JOGOK</h5>
      <p class="aszf-content__p">
        ...
        finaligaborrabbi@gmail.com e-mail címre küldött üzenettel keresse meg az
        Adatkezelőt.
      </p>

      <h5 class="aszf-content__h5">3.1. A hozzájárulás visszavonásának joga:</h5>
      ...
      <h5 class="aszf-content__h5">3.2. A személyes adatokhoz való hozzáférés</h5>
      ...
      <h5 class="aszf-content__h5">3.3. Helyesbítéshez való jog</h5>
      ...
      <h5 class="aszf-content__h5">3.4. Adatkezelés korlátozásához való jog</h5>
      ...
      <h5 class="aszf-content__h5">3.5. Törléshez – elfeledtetéshez való jog</h5>
      <p class="aszf-content__p">
      ...
      <p class="aszf-content__p">A törlés nem alkalmazandó, amennyiben az adatkezelés szükséges:</p>
      ...
      <p class="aszf-content__p">c) a népegészségügy területét érintő közérdek alapján;</p>
      ...
      <h5 class="aszf-content__p">3.6. Adathordozhatósághoz való jog</h5>
      ...
      <p class="aszf-content__p">a) az adatkezelés jogalapja az Ön kifejezett hozzájárulása, és</p>
      ...
      <h5 class="szf-content__h5">3.7. További információk</h5>
      ...
      <h5 class="aszf-content__h5">4. ADATBIZTONSÁGI INTÉZKEDÉSEK</h5>
      ...
      <h5 class="aszf-content__h5">5. JOGORVOSLATI LEHETŐSÉGEK</h5>
      ...
      <h5 class="aszf-content__h5">6. ADATKEZELÉSI TÁJÉKOZTATÓ MÓDOSÍTÁSA</h5>
